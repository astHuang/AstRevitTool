...
namespace AstRevitTool.Core
{
    public sealed class FilterUtil
    {
        ...
        /// <summary>
        /// Create an ElementFilter representing a selection ("ORing together") of FilterRules.
        /// </summary>
        /// <param name="filterRules">A list of FilterRules</param>
        /// <returns>The ElementFilter.</returns>
        public static ElementFilter CreateElementORFilterFromFilterRules(IList<FilterRule> filterRules)
        {
            // KEEP THIS FUNCTION SYNCHRONIZED WITH GetConjunctionOfFilterRulesFromElementFilter!!!
